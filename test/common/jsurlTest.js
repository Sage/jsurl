...
function t(v, r) {
	strictEqual(JSURL.stringify(v), r, "stringify " + JSON.stringify(v));
	strictEqual(JSURL.stringify(JSURL.parse(JSURL.stringify(v))), r, "roundtrip " + JSON.stringify(v));
}

test('basic values', 20, function() {
